...
function BlogInfo() {
    return (
        <>
            ...
            <div style={{ backgroundColor: "#F5F5F5", marginLeft: "24rem", width: "50vw", padding: "1rem", marginBottom: "4rem" }}>
                <img className="col-12 md:col-6 lg:col-6" style={{ marginTop: "4rem", width: "49vw" }} src="images/download.jfif" alt="bloginfo_image" />
